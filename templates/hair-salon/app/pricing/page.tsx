 ...
 *
 * @data_flow
 * - inputs: static pricing arrays and FAQs
 * - outputs: pricing cards and FAQ accordion
 *
 * @invariants
 * - Prices should match actual service pricing
 *
 * @issues
 * - [severity:low] None observed in-file.
 *
 * @verification
 * - Visit /pricing and confirm sections render correctly.
 *
 * @status
 * - confidence: high
...
export const metadata: Metadata = {
  title: 'Pricing | Hair Salon Template',
