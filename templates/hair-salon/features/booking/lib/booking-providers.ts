 ...
 *
 * @entrypoints
 * - External booking provider API calls
 * - Provider configuration management
 *
 * @exports
 * - bookingProviders
 * - createBookingWithProvider
 * - getProviderStatus
 *
 * @depends_on
 * - External: zod
 ...
 * @runtime
 * - environment: server
 * - side_effects: network requests
 *
 * @data_flow
 * - inputs: booking data, provider config
 * - outputs: provider booking responses
 *
 * @invariants
 * - All providers must be toggleable
