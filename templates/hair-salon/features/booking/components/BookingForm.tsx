 ...
 * - Internal: @repo/ui (UI components)
 * - Internal: @/features/booking/lib/booking-schema
 * - Internal: @/features/booking/lib/booking-actions
 ...
 * @runtime
 * - environment: client
 * - side_effects: form submissions, analytics events
 *
 * @data_flow
 * - inputs: user form data
 * - outputs: validated booking submissions
 *
 * @invariants
 * - Form must match booking schema exactly
 * - All submissions must trigger analytics events
