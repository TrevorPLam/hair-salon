...
- `scripts/check-bundle-size.mjs` — verifies Next.js bundle chunks stay within the performance budget
...
## Non-binding rule
- `P0TODO.md, P1TODO.md, P2TODO.md, P3TODO.md` is the task truth source.
