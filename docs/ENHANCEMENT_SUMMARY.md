...
- P0TODO.md, P1TODO.md, P2TODO.md, P3TODO.md is now strictly derived from specs/project-tasks.md (non-binding notes) (optional, non-binding) via scripts/sync-todo.sh
