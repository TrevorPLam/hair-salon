 ...
 *
 * @entrypoints
 * - Used by layout/providers to control analytics loading
 *
 * @exports
 * - default AnalyticsConsentBanner
 *
 * @depends_on
 * - External: react
 ...
 * @runtime
 * - environment: client
 * - side_effects: reads/writes consent storage, injects scripts
 *
 * @data_flow
 * - inputs: analyticsId, consent state
 * - outputs: banner UI and GA script injection
 *
 * @invariants
 * - Analytics must stay off until consent is granted
 *
 * @issues
 * - [severity:low] None observed in-file.
 *
 * @verification
 * - Toggle consent and ensure GA scripts only load after accept.
 *
 * @status
 * - confidence: high
