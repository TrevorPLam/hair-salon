 ...
 *
 * @depends_on
 * - Internal: @/features/booking/lib/booking-schema
 * - Internal: @/features/booking/lib/booking-providers
 * - Internal: @/lib/rate-limit
 *
 * @used_by
 ...
 * @runtime
 * - environment: server
 * - side_effects: network requests, database writes
 *
 * @data_flow
 * - inputs: validated booking data
 * - outputs: booking confirmation, errors
 *
 * @invariants
 * - All submissions must be rate limited
 * - Failed provider calls must not block internal booking
 * - Confirmation emails must be sent for successful bookings
 *
 * @security
